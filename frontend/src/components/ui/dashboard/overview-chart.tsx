...
export function OverviewChart() {
  return (
    // 1. Container que permite scroll se o conteúdo for maior que a tela
    <div className="overflow-x-auto pb-4">
      {/* 2. Forçamos uma largura mínima. 
          No Desktop (telas grandes), o container pai limita, então o width="100%" funciona.
          No Mobile, esse min-width força o scroll aparecer. */}
